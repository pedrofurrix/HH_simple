...
#                 spike_detector.spike_detector(bot_dir,param_dir,filtered=filter)
...
# order=3
                ...
                low_pass.filter_data(freq,e,cell_id,cutoff=100,results=None,var="cfreq",order=3,save=True,plot=True)
